...
export const Section0: React.FC<{ script: Script }> = ({ script }) => {
  ...
  return (
    <div style={{ ...SECTION_FRAME, background: PALETTE.white, fontFamily: FONT_BODY, color: BRAND_INK }}>
      ...
      <Piece id="s0.toolbar" kind="diegetic"><div style={{ position: "absolute", left: 8, top: 4, right: -8, bottom: -4 }}>
        <div
          style={{
            position: "absolute",
            top: 14,
      ...
      {/* Brand chrome */}
      <Piece id="s0.add1" kind="diegetic"><div style={{ position: "absolute", left: 198, top: 846, width: 795, height: 234, overflow: "hidden", zIndex: 1 }}><div
  style={{
    display: "flex",
    alignItems: "center",
    gap: 16,
