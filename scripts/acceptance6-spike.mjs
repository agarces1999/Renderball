// Tiny runner for scripts/acceptance6-spike.ts — esbuild-bundles the TS and
...
const result = await esbuild.build({
  entryPoints: [join(here, "acceptance6-spike.ts")],
  bundle: true,
  platform: "node",
  format: "esm",
  target: "node18",
...
const work = join(process.cwd(), "node_modules", ".cache", "rb-acceptance6-spike");
mkdirSync(work, { recursive: true });
const outFile = join(work, "acceptance6-spike.bundle.mjs");
