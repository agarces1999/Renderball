// Tiny runner for scripts/acceptance8-spike.ts — esbuild-bundles the TS and
...
const result = await esbuild.build({
  entryPoints: [join(here, "acceptance8-spike.ts")],
  bundle: true,
  platform: "node",
  format: "esm",
  target: "node18",
...
const work = join(process.cwd(), "node_modules", ".cache", "rb-acceptance8-spike");
mkdirSync(work, { recursive: true });
const outFile = join(work, "acceptance8-spike.bundle.mjs");
