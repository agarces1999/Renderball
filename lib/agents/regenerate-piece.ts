...
- Keep this element's ROLE and rough BOUNDS: a text element stays text, a diegetic UI mock stays a mock, an image stays an image. Position it with position:absolute + the same left/top region as the current one, and do NOT overlap the sibling elements listed.
