...
2. **VISUAL_CONCEPT FLOOR** — every visual_concept is ≥120 characters AND names ≥3 DISTINCT drawable elements (panel, card, window, chart, diagram, logo, wordmark, bar, button, icon, dots, terminal, ...). Count them per scene.
